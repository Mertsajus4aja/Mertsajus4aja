...
Распределение нагрузки преподавателей SQL 
...
Используя подзапросы, проведено распределение учителей по количеству проведенных в месяц уроков в штуках.
ВЫполнение запроса https://metabase.sky.pro/question/73833
